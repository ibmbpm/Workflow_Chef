...
# Recipe::create_singleclusters
#
# <> Configures IBM Business Automation Workflow SingleCluster on Multiple Nodes topology
#
...
workflow_createde 'ibm_workflow_createde' do
  ...
  ip_hostname_pairs  node['workflow']['ip_hostname_pairs']
